        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <ul className="mb-4 list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                Informasi profil: biografi, tautan media sosial, statistik
                audiens
              </li>
              <li>
                Informasi pembayaran: detail kartu kredit, akun bank (diproses
                secara aman melalui pihak ketiga)
              </li>
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>Data perangkat: jenis perangkat, sistem operasi, browser</li>
              <li>Data log: alamat IP, waktu akses, halaman rujukan</li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                <strong>Meningkatkan platform:</strong> Menganalisis penggunaan,
                mengembangkan fitur baru, mengoptimalkan pengalaman pengguna
              </li>
              <li>
                <strong>Keamanan:</strong> Mendeteksi dan mencegah penipuan,
                melindungi dari akses tidak sah
              </li>
              <li>
                <strong>Komunikasi:</strong> Mengirim pembaruan layanan,
                notifikasi, materi pemasaran (dengan persetujuan Anda)
              </li>
              <li>
                <strong>Kepatuhan:</strong> Mematuhi kewajiban hukum dan
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                ...
                hukum atau untuk melindungi hak kami
              </li>
              <li>
                <strong>Dengan persetujuan Anda:</strong> Ketika Anda secara
                eksplisit mengizinkan berbagi
              </li>
              <li>
                <strong>Transfer bisnis:</strong> Dalam hubungannya dengan
                merger, akuisisi, atau penjualan aset
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>Pemantauan rutin untuk kerentanan dan ancaman keamanan</li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                <strong>Koreksi:</strong> Meminta koreksi data yang tidak akurat
                atau tidak lengkap
              </li>
              <li>
                <strong>Penghapusan:</strong> Meminta penghapusan informasi
                pribadi Anda dalam kondisi tertentu
              </li>
              <li>
                <strong>Pembatasan:</strong> Meminta pembatasan pemrosesan data
                Anda
              </li>
              <li>
                <strong>Portabilitas:</strong> Menerima data Anda dalam format
                yang terstruktur dan dapat dibaca mesin
              </li>
              <li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                <strong>Cookie fungsional:</strong> Menyimpan preferensi dan
                pengaturan Anda
              </li>
              <li>
              ...
              <li>
                <strong>Cookie pemasaran:</strong> Digunakan untuk iklan yang
                ditargetkan
              </li>
            </ul>
            <p className="mt-4 text-zinc-600 dark:text-zinc-400">
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 text-zinc-600 dark:text-zinc-400">
              ...
              informasi dari seseorang di bawah usia 18 tahun, kami akan segera
          ...
          <section className="mb-12">
            ...
            <div className="text-zinc-600 dark:text-zinc-400">
              ...
              <p>
                <strong>Alamat:</strong> Jl. Sudirman No. 123, Jakarta Pusat,
                Indonesia
              </p>
            </div>
          </section>
