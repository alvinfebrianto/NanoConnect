        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-12">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              ...
              antara bisnis dan content creator.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                <strong>"Pengguna"</strong> mengacu pada individu atau entitas
                apa pun yang menggunakan Platform.
              </li>
              <li>
                <strong>"UMKM"</strong> mengacu pada usaha kecil dan menengah
                yang mencari layanan influencer.
              </li>
              <li>
                <strong>"Influencer"</strong> mengacu pada content creator yang
                menawarkan layanan promosi.
              </li>
              <li>
                <strong>"Pesanan"</strong> mengacu pada permintaan pemesanan
                untuk layanan influencer.
              </li>
              <li>
                <strong>"Konten"</strong> mengacu pada materi apa pun yang
                dibuat oleh influencer untuk kampanye.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                Segera memberi tahu kami tentang penggunaan akun Anda yang tidak
                sah
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ul className="mb-4 list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                Anda memiliki waktu 48 jam untuk meminta revisi setelah
                pengiriman konten
              </li>
              <li>
                Pengembalian dana diproses sesuai dengan kebijakan pengembalian
                dana kami
              </li>
            </ul>
            <p className="mb-4 text-zinc-600 dark:text-zinc-400">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                Anda harus memelihara informasi pembayaran yang akurat di profil
                Anda
              </li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                Terlibat dalam pelecehan, ujaran kebencian, atau perilaku
                diskriminatif
              </li>
              <li>
                Mencoba untuk menghindari biaya atau sistem pembayaran kami
              </li>
              <li>Menggunakan sistem otomatis untuk mengakses Platform</li>
              <li>
                Membagikan informasi rahasia yang diperoleh melalui Platform
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <ol className="list-inside list-decimal space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                Influencer meninjau dan menerima atau menolak permintaan dalam
                waktu 24 jam
              </li>
              <li>
                Setelah diterima, pembayaran diproses dan ditahan dalam escrow
              </li>
              <li>
                Influencer membuat dan mengirimkan konten sesuai tenggat waktu
                yang disepakati
              </li>
          ...
          <section className="mb-12">
            ...
            <ul className="mb-4 list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                ...
                dana 90% (biaya pemrosesan 10%)
              </li>
              <li>
                Setelah pekerjaan dimulai: Pengembalian dana sesuai
            ...
            <ul className="list-inside list-disc space-y-2 text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                Pembatalan berulang kali dapat mengakibatkan penangguhan akun
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="mb-4 text-zinc-600 dark:text-zinc-400">
              ...
              memberikan hak penggunaan kepada UMKM sebagaimana ditentukan dalam
              perjanjian pesanan.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              ...
              kami tidak akan melebihi jumlah yang dibayarkan untuk transaksi
          ...
          <section className="mb-12">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              ...
              yang mengikat sesuai dengan hukum yang berlaku di Indonesia.
            </p>
          </section>
