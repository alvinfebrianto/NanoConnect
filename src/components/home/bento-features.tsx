          ...
          <div className="relative lg:col-span-2 lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                <p className="mt-2 font-medium text-lg/7 text-stone-950 tracking-tight max-lg:text-center">
                  AI-Powered Matching
                </p>
                <p className="mt-2 max-w-lg text-sm/6 text-stone-600 max-lg:text-center">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-br-[calc(2rem+1px)]">
              ...
              <div className="flex flex-1 items-center justify-center px-8 max-lg:pt-10 max-lg:pb-12 sm:px-10 lg:pb-2">
                <div className="flex items-end gap-3 pb-8">
                  <div className="h-8 w-6 rounded-t-md bg-stone-200" />
