...
export function CallToAction() {
  return (
    <section className="relative isolate overflow-hidden bg-stone-900 py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              <Link
                className="flex-none rounded-md bg-amber-500 px-3.5 py-2.5 font-semibold text-sm text-white shadow-sm hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber-500 focus-visible:outline-offset-2"
                to="/register"
              >
                Daftar Gratis
              </Link>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 text-stone-400 leading-7">
