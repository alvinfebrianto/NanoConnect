  ...
  return (
    <section className="relative min-h-[80vh] w-full overflow-hidden bg-cream-50 pt-20 pb-16 lg:pt-32 lg:pb-20 dark:bg-zinc-950">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 right-0 -mt-20 -mr-20 h-[500px] w-[500px] animate-pulse-slow rounded-full bg-primary-400/20 blur-[100px]" />
        <div className="absolute bottom-0 left-0 -mb-20 -ml-20 h-[500px] w-[500px] animate-pulse-slow rounded-full bg-primary-400/20 blur-[100px]" />
      </div>

      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          <div className="mb-6 animate-fade-in opacity-0 [animation-delay:200ms] [animation-fill-mode:forwards]">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-1.5 font-semibold text-primary-600 text-sm shadow-sm ring-1 ring-black/5 backdrop-blur-md transition-transform hover:scale-105 dark:bg-zinc-800/80 dark:ring-white/10">
